package module5.AkkaActors

import Dispatcher.JsonParser.{Parse, ParseResponse}
import Dispatcher.LogWorker.{LogRequest, LogResponse}
import Dispatcher.TaskDispatcher.{LogWork, ParseUrl}
import akka.NotUsed
